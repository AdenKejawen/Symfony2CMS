...
namespace CMS\System\Bundle\DoctrineExtensionsBundle\DependencyInjection\Compiler;
...
class ValidateExtensionConfigurationPass implements CompilerPassInterface
{
    ...
    {
        $container->getExtension('cms_doctrine_extensions')->configValidate($container);
    }
}